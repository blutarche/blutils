...
export default function Tool() {
  const [input, setInput] = useToolInput('text.stats', '')
  ...
  return (
    <>
      <div class="tool-head">
        <h1>text.stats</h1>
        <button type="button" class="btn ghost sm" onClick={() => setInput(SAMPLE_TEXT)} title="Load sample" aria-label="Load sample"><Icon name="Sparkles" size={13} /></button>
        {!isEmpty && (
      ...
      <div class="two-col">
        ...
        <div class="panel">
          ...
          {isEmpty ? (
            <div class="tool-empty">Statistics appear here once you type or paste some text.</div>
          ) : (
            <div class="panel-b">
              <dl class="kv">
                <dt>characters</dt>
